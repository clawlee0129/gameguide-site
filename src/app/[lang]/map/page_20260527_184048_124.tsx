  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      ...
      <div className="mb-6 flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span className="text-gray-400">{dict.map.interactiveGameMap}</span>
      </div>
      ...
      <div className="mt-8 grid gap-6 rounded-xl border border-gray-800 bg-gray-900 p-6 md:grid-cols-2">
        <div>
          ...
          <div className="mt-3 space-y-2 text-sm">
            {[
              { type: "boss", label: dict.common.expert || "Boss", color: "#ef4444" },
              { type: "item", label: "Item / Chest", color: "#eab308" },
              { type: "teleport", label: "Site of Grace", color: "#3b82f6" },
              { type: "npc", label: "NPC", color: "#22c55e" },
