...
export const metadata: Metadata = {
  title: "Privacy Policy - GameGuide",
  description: "GameGuide Privacy Policy",
};
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0f0f0f]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold mb-8 text-gray-900 dark:text-white">{dict.privacy.title}</h1>
        <p className="text-gray-600 dark:text-[#a0a0a0] mb-8">{dict.privacy.lastUpdated}</p>
